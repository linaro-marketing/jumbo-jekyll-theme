...
{% include image.html path="/assets/images/test/background-image1.jpg" class="test" alt="" %}
{% include image.html path="/assets/images/test/background-image1.jpg"  class="" %}
...
{% include image.html path="/assets/images/test/background-image1.jpg" class="medium-inline right" %}
